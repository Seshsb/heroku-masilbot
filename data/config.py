...
########################################################################################################################
# Общее
CHOICE_LANGUAGE = 'Выберите язык/ (на корейском)'
...
GET_PHONE_NUMBER_KO = '핸드폰 번호를 입력해주세요'
...
BOOKING_KO = 'Бронирование 🕐'

DELIVERY_RU = 'Доставка 🚚'
DELIVERY_KO = 'Доставка 🚚'

CHANGE_LANG_RU = 'Поменять язык'
CHANGE_LANG_KO = 'Поменять язык'

CHANGE_LANG_SUCCESS_RU = 'Язык изменен успешно изменен.'
CHANGE_LANG_SUCCESS_KO = 'Язык изменен успешно изменен.'

BACK_TO_MAIN_PAGE_RU = 'Вернуться на главную страницу 📃'
BACK_TO_MAIN_PAGE_KO = 'Вернуться на главную страницу 📃'
...
BOOKING_FAILED_PEOPLE_KO = '몇 분인지 입력해주세요'
...
BOOKING_DETAIL_KO = 'Детали бронирования:\n\n' \
                    'Имя: {0}\n' \
                    'Телефон: {1}\n' \
                    'Дата и время: {2}\n' \
                    'Посадочное место: {3}\n' \
...
DELIVERY_REQUEST_CATEGORY_KO = 'Категории меню'

DELIVERY_REQUEST_DISH_RU = 'Выберите блюдо'
DELIVERY_REQUEST_DISH_KO = 'Выберите блюдо'

DELIVERY_REQUEST_QUANTITY_RU = 'Пожалуйста, выберите или введите количество'
DELIVERY_REQUEST_QUANTITY_KO = 'Пожалуйста, выберите или введите количество'

DELIVERY_BASKET_RU = 'Добавлено в корзину.\n' \
                     'Хотите что-то еще?'
DELIVERY_BASKET_KO = 'Добавлено в корзину.\n' \
                     'Хотите что-то еще?'

DELIVERY_INCORRECT_QUANTITY_RU = 'Количество порций должны состоять из цифр и не могут быть меньше нуля.\n' \
                                 'Попробуйте снова.'
DELIVERY_INCORRECT_QUANTITY_KO = 'Количество порций должны состоять из цифр и не могут быть меньше нуля.\n' \
                                 'Попробуйте снова.'
DELIVERY_PAYMENT_METHOD_RU = "<b>Выберите способ оплаты:</b>"
DELIVERY_PAYMENT_METHOD_KO = "<b>Выберите способ оплаты:</b>"

DELIVERY_CASH_METHOD_RU = 'Наличными 💵'
DELIVERY_CASH_METHOD_KO = 'Наличными 💵'
...
DELIVERY_CANCELED_KO = 'Сожалеем, но Ваш заказ отменен, нажмите на /start чтобы попробовать снова'

DELIVERY_CART_RU = '<b>Корзина:</b>\n\n\n'
DELIVERY_CART_KO = '<b>Корзина:</b>\n\n\n'
...
DELIVERY_ORDER_ACCEPT_CLIENT_RU = '<b>Ваш заказ #{0}</b>\n' \
                                  'Тип заказа: <b> "Доставка 🚘"</b>\n' \
                                  'Адрес: <b>{1}</b>\n' \
                                  'Номер телефона: <b>{2}</b>\n' \
                                  'Метод оплаты: <b>{3}</b>\n'
DELIVERY_ORDER_ACCEPT_CLIENT_KO = '<b>Ваш заказ #{0}</b>\n' \
                                  'Тип заказа: <b> "Доставка 🚘"</b>\n' \
                                  'Адрес: <b>{1}</b>\n' \
                                  'Номер телефона: <b>{2}</b>\n' \
                                  'Метод оплаты: <b>{3}</b>\n'

DELIVERY_ORDER_ACCEPT_CLIENT_TAKEAWAY_RU = '<b>Заказ #{0}</b>\n' \
                                           'Тип заказа: <b>На вынос 🏃🏻‍♂️</b>\n' \
                                           'Адрес ресторана: <b>Мирабад, 41</b>\n' \
                                           'Номер телефона: <b>{1}</b>\n' \
                                           'Метод оплаты: <b>{2}</b>\n\n\n'
DELIVERY_ORDER_ACCEPT_CLIENT_TAKEAWAY_KO = '<b>Заказ #{0}</b>\n' \
                                           'Тип заказа: <b>На вынос 🏃🏻‍♂️</b>\n' \
                                           'Адрес ресторана: <b>Мирабад, 41</b>\n' \
                                           'Номер телефона: <b>{1}</b>\n' \
                                           'Метод оплаты: <b>{2}</b>\n\n\n'
...
DELIVERY_ORDER_ACCEPT_ADMIN_RU = '<b>Заказ #{0}</b>\n' \
                                 ...
                                 'Номер телефона: <b>{2}</b>\n' \
                                 'Метод оплаты: <b>{3}</b>\n'
DELIVERY_ORDER_ACCEPT_ADMIN_KO = '<b>Заказ #{0}</b>\n' \
                                 'Тип заказа: <b> "Доставка 🚘"</b>\n' \
                                 'Адрес: <b>{1}</b>\n' \
                                 'Номер телефона: <b>{2}</b>\n' \
                                 'Метод оплаты: <b>{3}</b>\n'
...
DELIVERY_ORDER_ACCEPT_ADMIN_TAKEAWAY_RU = '<b>Заказ #{0}</b>\n' \
                                          ...
                                          'Номер телефона: <b>{1}</b>\n' \
                                          'Метод оплаты: <b>{2}</b>\n\n\n'
DELIVERY_ORDER_ACCEPT_ADMIN_TAKEAWAY_KO = '<b>Заказ #{0}</b>\n' \
                                          'Тип заказа: <b>На вынос 🏃🏻‍♂️</b>\n' \
                                          'Номер телефона: <b>{1}</b>\n' \
                                          'Метод оплаты: <b>{2}</b>\n\n\n'
...
DELIVERY_ORDER_CLIENT_WAIT_ACCEPT_KO = 'Спасибо за ожидание, ваш заказ <b>#{}</b> ' \
                                       'передан на обработку. С вами свяжется оператор.'

DELIVERY_QUESTION_ACCEPT_RU = '<b>Подтвердить заказ?</b>'
DELIVERY_QUESTION_ACCEPT_KO = '<b>Подтвердить заказ?</b>'

DELIVERY_COST_RU = "<b>Введите сумму доставки</b>"
DELIVERY_COST_KO = "<b>Введите сумму доставки</b>"
...
DELIVERY_ORDER_KO = '<b>Ваш заказ #{0}</b>\n' \
                    'Тип заказа: <b> "Доставка 🚘"</b>\n' \
                    'Адрес: <b>{1}</b>\n' \
                    'Номер телефона: <b>{2}</b>\n' \
                    'Метод оплаты: <b>{3}</b>\n' \
...
DELIVERY_ORDER_TAKEAWAY_RU = '<b>Ваш заказ #{0}</b>\n' \
                             ...
                             'Метод оплаты: <b>{2}</b>\n\n\n ' \
                             'Время получения заказа: <b>В ближайшее время</b>\n\n\n'
DELIVERY_ORDER_TAKEAWAY_KO = '<b>Ваш заказ #{0}</b>\n' \
                             'Тип заказа: <b>На вынос 🏃🏻‍♂️</b>\n' \
                             'Адрес ресторана: <b>Мирабад, 41</b>\n' \
                             'Номер телефона: <b>{1}</b>\n' \
                             'Метод оплаты: <b>{2}</b>\n\n\n ' \
...
DELIVERY_SOMETHING_ELSE_KO = 'Хотите что-то еще?'
    ...
    'delivery':
        {
            ...
            'DELIVERY_CANCELES_KO': DELIVERY_CANCELED_KO,
