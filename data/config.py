...
DELIVERY_REQUEST_ADDRESS_RU = '<b>Вы можете ввести свой адрес, отправить в ручную геолокацию ' \
                              'или нажмите на "Поделиться геолокацией" и ' \
                              'телеграм определит ваше местоположение автоматически</b>'
DELIVERY_REQUEST_ADDRESS_KO = '<b>Вы можете ввести свой адрес, отправить в ручную геолокацию ' \
                              'или нажмите на "Поделиться геолокацией" и ' \
                              'телеграм определит ваше местоположение автоматически</b>'
